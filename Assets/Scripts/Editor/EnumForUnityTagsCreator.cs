...
namespace Core
{
    internal class EnumForUnityTagsCreator : OdinEditorWindow
    {
        ...
        {
            var window = CreateWindow<EnumForUnityTagsCreator>();
        }
        ...
        private void Create()
        {
            ...
            sb.Append($"// Code generated by {nameof(EnumForUnityTagsCreator)}.cs. Use menu item \"{MenuPath}\" to update\n\n");
