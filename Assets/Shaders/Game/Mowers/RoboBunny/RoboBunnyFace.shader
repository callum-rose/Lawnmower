...
Shader "RoboBunnyFace"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_FaceTex("FaceTex", 2D) = "white" {}
		[HDR]_LedColour("LedColour", Color) = (2,2,2,1)
		_OffColour("OffColour", Color) = (0.1792453,0.1792453,0.1792453,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_FaceTex = IN.ase_texcoord7.xy * _FaceTex_ST.xy + _FaceTex_ST.zw;
				float4 lerpResult10 = lerp( color12 , _LedColour , tex2D( _FaceTex, uv_FaceTex ).r);
				
				float3 Albedo = _OffColour.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = lerpResult10.rgb;
				float3 Specular = 0.5;
...
/*ASEBEGIN
Version=18500
0;16.88889;1695.556;883.4445;1592.3;680.4995;1.504744;True;True
Node;AmplifyShaderEditor.SamplerNode;6;-564.2629,-44.66144;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;7;-815.5551,50.13745;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;8;-1114.999,-55.19464;Inherit;True;Property;_FaceTex;FaceTex;0;0;Create;True;0;0;False;0;False;None;9fe16223a73a6384d8fcf0b0c8aa0339;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.LerpOp;10;-51.14516,-67.23261;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;12;-460.3978,-408.8094;Inherit;False;Constant;_Color0;Color 0;3;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;9;-469.4641,-219.2117;Inherit;False;Property;_LedColour;LedColour;1;1;[HDR];Create;True;0;0;False;0;False;2,2,2,1;6.431373,0.7843137,0.7843137,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;-460.4355,-577.3406;Inherit;False;Property;_OffColour;OffColour;2;0;Create;True;0;0;False;0;False;0.1792453,0.1792453,0.1792453,1;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-66.48919,98.95798;Inherit;False;Property;_Metallic;Metallic;3;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-52.94647,189.2426;Inherit;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=29D8E821704DAE0E113A831178B0581D41BBCC20