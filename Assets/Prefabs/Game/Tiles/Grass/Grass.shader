...
Shader "Grass"
{
	Properties
	{
		...
		_MaxWindFactor("MaxWindFactor", Float) = 0.0001
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float2 texCoord50_g20 = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				float2 temp_output_8_0_g20 = ( ( texCoord50_g20.x * float2( 10,10 ) ) + ( (ase_worldPos).xz * _VertexOffsetNoiseSize ) + ( _VertexOffsetNoiseVelocity * _TimeParameters.x ) );
				float simplePerlin2D3_g20 = snoise( temp_output_8_0_g20 );
				float simplePerlin2D12_g20 = snoise( ( float2( 10,10 ) + temp_output_8_0_g20 ) );
				float3 appendResult14_g20 = (float3(simplePerlin2D3_g20 , 0.0 , simplePerlin2D12_g20));
				float2 texCoord54_g20 = v.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float simplePerlin2D63_g20 = snoise( texCoord54_g20*_Float1 );
				float simplePerlin2D64_g20 = snoise( ( texCoord54_g20 + float2( 10,10 ) )*_Float1 );
				float2 appendResult66_g20 = (float2(simplePerlin2D63_g20 , simplePerlin2D64_g20));
				float2 break59_g20 = ( appendResult66_g20 * _Float0 );
				float3 appendResult55_g20 = (float3(break59_g20.x , 0.0 , break59_g20.y));
				float2 texCoord47_g20 = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				#endif
				float3 vertexValue = ( ( ( appendResult14_g20 * _MaxWindFactor ) + appendResult55_g20 ) * ( texCoord47_g20.y * texCoord47_g20.y ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
...
/*ASEBEGIN
Version=18500
-1914;13;1920;1029;980.0149;493.459;1;True;True
Node;AmplifyShaderEditor.FunctionNode;5;-220,-83.5;Inherit;False;Toon;0;;1;a4a352ddda5e97a438bc3f7dc43e6fb7;0;0;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;24;-324.0149,12.54099;Inherit;False;Grass Vertex Offset New;12;;20;875d573184573524baee39a5588c350f;0;0;1;FLOAT3;0
...
ASEEND*/
//CHKSM=99B0022EAD6FE241B9BF6A0331005AA3B9A98DD9