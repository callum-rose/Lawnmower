...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		[ASEBegin]_NoiseScale("NoiseScale", Float) = 0.5
		_FogColour("FogColour", Color) = (1,1,1,1)
		FogRange("FogRange", Vector) = (-10,-1,0,0)
		_Colour1("Colour1", Color) = (0,0,0,0)
		[ASEEnd]_Colour2("Colour2", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float simplePerlin2D8 = snoise( ( (WorldPosition).xz + WorldPosition.y )*_NoiseScale );
				simplePerlin2D8 = simplePerlin2D8*0.5 + 0.5;
				float4 lerpResult12 = lerp( _Colour1 , _Colour2 , ( 1.0 - ( round( frac( ( simplePerlin2D8 + WorldPosition.y ) ) ) * 2 ) ));
				float4 lerpResult7_g8 = lerp( _FogColour , lerpResult12 , (0.0 + (WorldPosition.y - FogRange.x) * (1.0 - 0.0) / (FogRange.y - FogRange.x)));
				
				float3 Albedo = lerpResult7_g8.rgb;
...
/*ASEBEGIN
Version=18500
5.777778;4.444445;1695.111;904.3333;442.5565;610.5;1;True;True
Node;AmplifyShaderEditor.WorldPosInputsNode;6;-1009.555,-128.5;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ComponentMaskNode;9;-792.5555,-209.5;Inherit;False;True;False;True;True;1;0;FLOAT3;0,0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-587.5555,-130.5;Inherit;False;Property;_NoiseScale;NoiseScale;0;0;Create;True;0;0;False;0;False;0.5;0.39;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;15;-524.5555,-225.8334;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;8;-373.5555,-212.5;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;10;-142.5555,-102.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;13;19.44446,-415.5;Inherit;False;Property;_Colour1;Colour1;4;0;Create;True;0;0;False;0;False;0,0,0,0;0.4528302,0.3225294,0.09161031,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;7;40.44446,-85.5;Inherit;True;Square Wave;-1;;1;6f8df4c09ccca5d42b0d3d422aad9cbd;0;1;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;14;46.44446,-254.5;Inherit;False;Property;_Colour2;Colour2;5;0;Create;True;0;0;False;0;False;0,0,0,0;0.582,0.4164311,0.1204138,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;12;332.4445,-242.5;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;22;544.4438,-227.1667;Inherit;True;YFog;1;;8;e8226edbf7b18ad44bce271aedf452b1;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;780,-242;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;0;  Use Shadow Threshold;0;Receive Shadows;0;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;False;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=1A71F744F19883E7DB6E93917BAAFB5040C211BA